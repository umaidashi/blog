...
export const H2 = ({
  ...
  return (
    <h2 className="text-3xl font-bold mt-5">
      <HeadingPrefix num={2} /> {props.children}
    </h2>
  );
};
...
export const H3 = ({
  ...
  return (
    <h3 className="text-2xl font-bold mt-4">
      <HeadingPrefix num={3} /> {props.children}
    </h3>
  );
};
...
export const H6 = ({
  ...
  HTMLAttributes<HTMLHeadingElement>) => {
  return (
    <h6 className="text-base font-bold mt-1">
      <HeadingPrefix num={6} /> {children}
    </h6>
  );
};
